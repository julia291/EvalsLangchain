...
from rules import random_whole_flags, random_name_flags, random_domain_flags, random_tld_flags
...
def main():
    ...
    check_type = "recipient"
    phrases_that_will_be_checked = random_whole_flags(env.mails, rel_size=0.3)
    env.set_phrases(check_type, phrases_that_will_be_checked)
    ...
    if env.processed_emails:
        ...
        print("CWD:", os.getcwd())
        print("results_path:", os.path.abspath(results_path))
        ...
        logger.warning("Keine E-Mails bearbeitet, keine Ergebnisse zum Speichern.")
