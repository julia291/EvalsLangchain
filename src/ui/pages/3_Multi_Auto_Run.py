...
# The surveillance rule is global to the whole sweep. This keeps the batch focused
# on the planned parameter dimensions (`target_injections` x `max_flags`) instead
# of mixing in a different scan rule per repetition.
